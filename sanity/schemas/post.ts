...
export const post = defineType({
  ...
  fields: [
    ...
    defineField({
      ...
      type: 'text',
      rows: 4,
      description: 'Short description for SEO and preview cards (160 characters max)',
    ...
    defineField({
      ...
      description: 'Add affiliate products featured in this post',
    }),
    defineField({
      name: 'seo',
      title: 'SEO Settings',
      ...
      fields: [
        ...
        },
        {
          ...
          description: 'Add 5-10 keywords for SEO. Click "Add item" button, type keyword, then click outside the field to save each one.',
